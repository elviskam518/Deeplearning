...
class InvertedResidual(nn.Module):
    def __init__(self, in_ch, out_ch, stride=2, expand_ratio=2.6):
        super().__init__()
...
class Classifier(nn.Module):
    def __init__(self, params):
        ...
        self.conv1 = nn.Conv2d(params["n_channels"], 32, kernel_size=3, padding=1, bias=False)
        self.bn1   = nn.BatchNorm2d(32)

        self.ds_conv2 = DepthwiseSeparableConv(32, 64, stride=2)

        self.ir_conv3 = InvertedResidual(64, 128, stride=2, expand_ratio=2.6)
...
def main():
    ...
    train_tf = T.Compose([
        ...
        T.RandAugment(num_ops=1, magnitude=4),
        T.ToTensor(),
